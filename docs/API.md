...
> The released version is **0.8.0**, and the documents that describe it are the tree at its tag —
> open a file at `v0.8.0` to read the reference for what you can install today.
>
